 ...
 */
class getStandRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StandRepository' shared autowired service.
     *
     * @return \App\Repository\StandRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StandRepository.php';

        return $container->privates['App\\Repository\\StandRepository'] = new \App\Repository\StandRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
