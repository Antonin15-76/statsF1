 ...
 */
class getCircuitsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CircuitsRepository' shared autowired service.
     *
     * @return \App\Repository\CircuitsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CircuitsRepository.php';

        return $container->privates['App\\Repository\\CircuitsRepository'] = new \App\Repository\CircuitsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
